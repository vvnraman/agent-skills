---
name: project-docs-rst
description: Draft, rewrite, and review Sphinx project documentation in reStructuredText using Divio documentation types and project maintenance pages under docs/project.
---
...
- Prefer project-level maintenance pages under `docs/project/` when that structure exists.
- Maintain `docs/project/index.rst`, `changelog.rst`, and `plan.rst` when relevant to the requested change.
